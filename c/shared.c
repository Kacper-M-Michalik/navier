...
int simulate_profiling(int init_ibound, double xlength, double ylength, int imax, int jmax, double t_end, double del_t, double tau, 
int itermax, double eps, double omega, double gamma, double Re, double ui, double vi, 
double** u, double** v, double** p, double** rhs, double** f, double** g, char** flag)
{
    double t, delx, dely;
    int  i, j, itersor = 0, ifluid = 0, ibound = init_ibound;
    double res;
    int iters = 0;
